...
public class GUI extends JFrame {
	...
	if (btnLoad == null) {
		...
		public void actionPerformed(ActionEvent arg0) {
		    try {
			// Táº¡o giao diá»‡n cho ngÆ°á»�i dÃ¹ng nháº­p username vÃ  password cá»§a database
			...
			// Táº¡o nÆ¡i Ä‘iá»�n username vÃ  password
			...
			// Táº£i dá»¯ liá»‡u tá»« database vÃ o pháº§n má»�m
			data = manager.getAll();

			// Thiáº¿t káº¿ báº£ng dá»¯ liá»‡u Ä‘á»ƒ hiá»ƒn thá»‹
			...
			// KÃ­ch hoáº¡t cÃ¡c chá»©c nÄƒng Add, Delete, táº¯t pháº§n thÃ´ng bÃ¡o
	...
	try {
	    ...
	    // Kiá»ƒm tra dá»¯ liá»‡u nháº­p vÃ o, kiá»ƒm tra trÃ¹ng khÃ³a chÃ­nh trong database
	    ...
	    // Cáº­p nháº­t hiá»ƒn thá»‹ database cho pháº§n má»�m
	    data = manager.getAll();
	    ((DefaultTableModel) (table.getModel())).setDataVector(data, header);
	...
	try {
	    ...
	    // Kiá»ƒm tra sinh viÃªn cÃ³ trong database hay khÃ´ng
	    if (!manager.checkStudent(Sno)) throw new Exception("This student ID is not exits in database, So can delete!");
	    manager.delete(Sno);

	    // Cáº­p nháº­t láº¡i dá»¯ liá»‡u hiá»ƒn thá»‹ trÃªn pháº§n má»�m
	    data = manager.getAll();
	    ((DefaultTableModel) (table.getModel())).setDataVector(data, header);
    ...
    {
	try {
	    // Kiá»ƒm tra database trÆ°á»›c khi in
